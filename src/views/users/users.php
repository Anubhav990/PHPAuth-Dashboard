    ...
    <div class="main-container">
        ...
        <div class="main">
            ...
            <div class="admin-create-user"> 
                <a href="<?php echo $constants['paths']['CreateNewUser']; ?>"><button>create a new user</button></a>
            </div>
                    ...
                    <tbody>
                        ...
                        if($result->num_rows > 0){
                            ...
                            while($row = $result->fetch_assoc()){
                                ...
                                <td data-label='Actions'> <a href='./edit.php?id={$row['id']}' class='action-button edit-button'>Edit</a> 
